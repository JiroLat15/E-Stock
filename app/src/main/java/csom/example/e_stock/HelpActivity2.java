...
public class HelpActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.help_layout_2ndpage);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HelpActivity2.this, HelpActivity1.class);
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(HelpActivity2.this, eStockHomePage.class);
                startActivity(intent);
